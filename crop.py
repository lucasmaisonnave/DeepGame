...
IMG_PATH = './images/0x72_DungeonTilesetII_v1.3.1/0x72_DungeonTilesetII_v1.3.png'
TILES_PATH = './images/0x72_DungeonTilesetII_v1.3.1/tiles_list_v1.3'
...
def saveCrop(img, title, box):
    path = os.path.join('./images/0x72_DungeonTilesetII_v1.3.1/frames/' + title + '.png')
    try:
